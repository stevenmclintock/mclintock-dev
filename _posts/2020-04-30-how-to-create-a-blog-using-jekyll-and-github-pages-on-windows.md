...
The **url** setting is what Jekyll uses to determine the domain name of your website. For example, the Jekyll website you are currently on uses the domain name **https://mclintock.dev**, so that's the url value used for this website.
...
*https://mclintock.dev/jekyll/2020/04/30/how-to-create-a-blog-using-jekyll-and-github-pages-on-windows/*

```yaml
permalink: /:categories/:year/:month/:day/:title/
```

*https://mclintock.dev/2020/04/30/how-to-create-a-blog-using-jekyll-and-github-pages-on-windows/*

```yaml
permalink: /:year/:month/:day/:title/
```

*https://mclintock.dev/how-to-create-a-blog-using-jekyll-and-github-pages-on-windows/*
